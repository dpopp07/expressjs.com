...
debug logs for this behavior are no longer available under the `express:` namespace.
...
In v5, the logs are available under the namespaces `router`, `router:layer`, and `router:route`.
